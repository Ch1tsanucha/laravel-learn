        ...
        <nav class="bg-gray-800">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nave href="/" :active="request()->is('/')">Home</x-nave>
                                <x-nave href="/jobs" :active="request()->is('jobs')">jobs</x-nave>
                                <x-nave href="/contact" :active="request()->is('contact')">Contact</x-nave>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                    <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                    <x-nave href="/" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white"
                        aria-current="page">Home </x-nave>
                    <a href="/about"
